        ...
        <div class="col-lg-8 text-center mx-auto text-white p-b-30">
          ...
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb bg-transparent">
              ...
              <li class="breadcrumb-item active" aria-current="page">Vahid əlavə edin
              </li>
            </ol>
          </nav>
        </div>
              ...
              @endif
                <form method="post" action="{{ route('admin.unit.store') }}">
                    ...
                    <div class="form-group col-12">
                        ...
                        <input type="text" name="name" value="{{ old('name') ?? '' }}" class="form-control @error('name') {{  'is-invalid' }} @enderror" id="inputName" placeholder="Vahidin adı">
                        @error('name')
