            ...
            <div class="col d-lg-block d-none m-b-30">
                <div class="card ">
                    <div class="   text-center card-body">
                        <div class="text-danger   ">
                            <div class="avatar avatar-sm ">
                                <span class="avatar-title rounded-circle badge-soft-danger"><i class="mdi mdi-arrow-up-bold mdi-18px"></i> </span>
                        ...
                        <table class="table table-hover table-sm ">
                            ...
                            <tr>
                                <td class="align-middle">
                                    <div class="avatar avatar-sm avatar-online"><img src="assets\img\users\user-1.jpg" class="avatar-img avatar-sm rounded-circle" alt="user-image"></div>
                            ...
                            <tr>
                                <td class="align-middle">
                                    <div class="avatar avatar-sm avatar-online"><img src="assets\img\users\user-2.jpg" class="avatar-img avatar-sm rounded-circle" alt="user-image"></div>
                            ...
                            <tr>
                                <td class="align-middle">
                                    <div class="avatar avatar-sm avatar-offline"><img src="assets\img\users\user-3.jpg" class="avatar-img avatar-sm rounded-circle" alt="user-image"></div>
                            ...
                            <tr>
                                <td class="align-middle">
                                    <div class="avatar avatar-sm avatar-offline"><img src="assets\img\users\user-4.jpg" class="avatar-img avatar-sm rounded-circle" alt="user-image"></div>
                            ...
                            <tr>
                                <td class="align-middle">
                                    <div class="avatar avatar-sm avatar-online"><img src="assets\img\users\user-5.jpg" class="avatar-img avatar-sm rounded-circle" alt="user-image"></div>
                            ...
                            <tr>
                                <td class="align-middle">
                                    <div class="avatar avatar-sm avatar-offline"><img src="assets\img\users\user-6.jpg" class="avatar-img avatar-sm rounded-circle" alt="user-image"></div>
                ...
                <div class="card ">
                    ...
                    <div class="list-group list-group-flush ">
                        ...
                        <div class="list-group-item d-flex  align-items-center">
                            <div class="m-r-20">
                                <div class="avatar avatar-sm "><img src="assets\img\social\s5.jpg" class="avatar-img avatar-sm rounded" alt="user-image">
                                </div>
                            </div>
                            <div class="">
                                <div>Recess.jpg</div>
                        ...
                        <div class="list-group-item d-flex  align-items-center">
                            <div class="m-r-20">
                                <div class="avatar avatar-sm "><img src="assets\img\social\s4.jpg" class="avatar-img avatar-sm rounded" alt="user-image">
                                </div>
                            </div>
                            <div class="">
                                <div>Outing.jpg</div>
                        ...
                        <div class="list-group-item d-flex  align-items-center">
                            <div class="m-r-20">
                                <div class="avatar avatar-sm "><img src="assets\img\logos\nytimes.jpg" class="avatar-img avatar-sm rounded" alt="user-image">
                                </div>
                            </div>
                            <div class="">
                                <div>Client.png</div>
