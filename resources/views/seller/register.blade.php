        ...
        <div class="col-lg-4  bg-white">
          <div class="row align-items-center m-h-100">
            <div class="mx-auto col-md-8">
              ...
              @endif
              <h3 class="text-center p-b-20 fw-400">Qeydiyyat</h3>
              <form class="needs-validation" action="{{ route('seller.store') }}" method="POST">
                @csrf
                <div class="form-row">
                  <div class="form-group floating-label col-md-12">
                    <label>Ad</label>
                    <input type="text" value="{{ old('name') ?? '' }}" name="name" class="form-control @error('name') is-invalid @enderror" placeholder="Ad">
                    @error('name')
                  ...
                  <div class="form-group floating-label col-md-12">
                    <label>Soyad</label>
                    <input type="text" name="surname" placeholder="Soyad" class="form-control @error('surname') is-invalid @enderror">
                    @error('surname')
                    <span class="invalid-feedback" role="alert">
                      <strong>{{ $message }}</strong>
                    </span>
                ...
                <div class="form-row">
                  ...
                  <div class="form-group floating-label col-md-12">
                    <label>Şifrə</label>
                    <input type="password" name="password" required="" placeholder="Şifrə" class="form-control @error('password') is-invalid @enderror">
                    @error('password')
                    <span class="invalid-feedback" role="alert">
                      <strong>{{ $message }}</strong>
                    </span>
                ...
                <div class="form-group floating-label">
                  <label>Şifrə Yenidən</label>
                  <input type="password" name="password_confirmation" class="form-control" id="confirm_password" placeholder="Şifrə yenidən">
                  @error('password')
                    <span class="invalid-feedback" role="alert">
                      <strong>{{ $message }}</strong>
                    </span>
                ...
                <button type="submit" class="btn btn-primary btn-block btn-lg">Qeyd Ol</button>
