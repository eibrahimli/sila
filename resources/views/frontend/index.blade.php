                                                        ...
                                                        <ul class="navbar-nav u-header__navbar-nav">
                                                            ...
                                                            <li class="nav-item hs-has-mega-menu u-header__nav-item"
                                                                ...
                                                                <div class="hs-mega-menu vmm-tfw u-header__sub-menu" aria-labelledby="basicMegaMenu">
                                                                    <div class="vmm-bg">
                                                                        <img class="img-fluid" src="{{ asset('frontend/img/500X400/img1.png') }}" alt="Image Description">
                                                                    </div>
                                                            ...
                                                            <li class="nav-item hs-has-mega-menu u-header__nav-item"
                                                                ...
                                                                <div class="hs-mega-menu vmm-tfw u-header__sub-menu" aria-labelledby="basicMegaMenu1">
                                                                    <div class="vmm-bg">
                                                                        <img class="img-fluid" src="{{ asset('frontend/img/500X400/img4.png') }}" alt="Image Description">
                                                                    </div>
                                                                    <div class="row u-header__mega-menu-wrapper">
                                                                        <div class="col mb-3 mb-sm-0">
                                                            ...
                                                            <li class="nav-item hs-has-mega-menu u-header__nav-item"
                                                                ...
                                                                <div class="hs-mega-menu vmm-tfw u-header__sub-menu vmm-bg-extended" aria-labelledby="basicMegaMenu2">
                                                                    <div class="vmm-bg">
                                                                        <img class="img-fluid" src="{{ asset('frontend/img/500X400/img3.png') }}" alt="Image Description">
                                                                    </div>
                                                                    <div class="row u-header__mega-menu-wrapper">
                                                                        <div class="col mb-3 mb-sm-0">
                                                            ...
                                                            <li class="nav-item hs-has-mega-menu u-header__nav-item"
                                                                ...
                                                                <div class="hs-mega-menu vmm-tfw u-header__sub-menu" aria-labelledby="basicMegaMenu3">
                                                                    <div class="vmm-bg">
                                                                        <img class="img-fluid" src="{{ asset('frontend/img/500X400/img2.png') }}" alt="Image Description">
                                                                    </div>
                                                                    <div class="row u-header__mega-menu-wrapper">
                                                                        <div class="col mb-3 mb-sm-0">
                                                            ...
                                                            <li class="nav-item hs-has-mega-menu u-header__nav-item"
                                                                ...
                                                                <div class="hs-mega-menu vmm-tfw u-header__sub-menu" aria-labelledby="basicMegaMenu4">
                                                                    <div class="vmm-bg">
                                                                        <img class="img-fluid" src="{{ asset('frontend/img/500X400/img5.png') }}" alt="Image Description">
                                                                    </div>
                                                                    <div class="row u-header__mega-menu-wrapper">
                                                                        <div class="col mb-3 mb-sm-0">
                                                                            <span class="u-header__sub-menu-title">Audio & Video</span>
                                                            ...
                                                            <li class="nav-item hs-has-mega-menu u-header__nav-item"
                                                                ...
                                                                <div class="hs-mega-menu vmm-tfw u-header__sub-menu" aria-labelledby="basicMegaMenu5">
                                                                    <div class="vmm-bg">
                                                                        <img class="img-fluid" src="{{ asset('frontend/img/500X400/img6.png') }}" alt="Image Description">
                                                                    </div>
                                                                    <div class="row u-header__mega-menu-wrapper">
                                                                        <div class="col mb-3 mb-sm-0">
                                                            ...
                                                            <li class="nav-item hs-has-mega-menu u-header__nav-item"
                                                                ...
                                                                <div class="hs-mega-menu vmm-tfw u-header__sub-menu" aria-labelledby="basicMegaMenu3">
                                                                    <div class="vmm-bg">
                                                                        <img class="img-fluid" src="{{ asset('frontend/img/500X400/img7.png') }}" alt="Image Description">
                                                                    </div>
                                                                    <div class="row u-header__mega-menu-wrapper">
                                                                        <div class="col mb-3 mb-sm-0">
                    ...
                    <div class="row">
                            ...
                            <a href="../shop/shop.html" class="d-black text-gray-90">
                                <div class="min-height-132 py-1 d-flex bg-gray-1 align-items-center">
                                    <div class="col-6 col-xl-5 col-wd-6 pr-0">
                                        <img class="img-fluid" src="{{ asset('frontend/img/190X150/img1.png') }}" alt="Image Description">
                                    </div>
                        ...
                        <div class="col-md-6 mb-4 mb-xl-0 col-xl-3">
                            <a href="../shop/shop.html" class="d-black text-gray-90">
                                <div class="min-height-132 py-1 d-flex bg-gray-1 align-items-center">
                                    <div class="col-6 col-xl-5 col-wd-6 pr-0">
                                        <img class="img-fluid" src="{{ asset('frontend/img/190X150/img2.jpg') }}" alt="Image Description">
                                    </div>
                                    <div class="col-6 col-xl-7 col-wd-6">
                                        <div class="mb-2 pb-1 font-size-18 font-weight-light text-ls-n1 text-lh-23">
                                            CATCH BIG <strong>DEALS</strong> ON THE CAMERAS
                        ...
                        <div class="col-md-6 mb-4 mb-xl-0 col-xl-3">
                            <a href="../shop/shop.html" class="d-black text-gray-90">
                                <div class="min-height-132 py-1 d-flex bg-gray-1 align-items-center">
                                    <div class="col-6 col-xl-5 col-wd-6 pr-0">
                                        <img class="img-fluid" src="{{ asset('frontend/img/190X150/img3.jpg') }}" alt="Image Description">
                                    </div>
                                    <div class="col-6 col-xl-7 col-wd-6">
                                        <div class="mb-2 pb-1 font-size-18 font-weight-light text-ls-n1 text-lh-23">
                                            CATCH BIG <strong>DEALS</strong> ON THE CAMERAS
                        ...
                        <div class="col-md-6 mb-4 mb-xl-0 col-xl-3">
                            <a href="../shop/shop.html" class="d-black text-gray-90">
                                <div class="min-height-132 py-1 d-flex bg-gray-1 align-items-center">
                                    <div class="col-6 col-xl-5 col-wd-6 pr-0">
                                        <img class="img-fluid" src="{{ asset('frontend/img/190X150/img4.png') }}" alt="Image Description">
                                    </div>
                                    <div class="col-6 col-xl-7 col-wd-6">
                                        <div class="mb-2 pb-1 font-size-18 font-weight-light text-ls-n1 text-lh-23">
                                            CATCH BIG <strong>DEALS</strong> ON THE CAMERAS
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-auto mb-6 mb-md-0">
                            <div class="p-3 border border-width-2 border-primary borders-radius-20 bg-white min-width-370">
                                ...
                                <div class="mb-4">
                                    <a href="../shop/single-product-fullwidth.html" class="d-block text-center"><img class="img-fluid" src="{{ asset('frontend/img/320X300/img1.jpg') }}" alt="Image Description"></a>
                                </div>
                                                ...
                                                <div class="product-item__inner bg-white p-3">
                                                    <div class="product-item__body d-flex flex-column">
                                                        ...
                                                        <div class="mb-1 min-height-4-1-4">
                                                            <a href="#" class="d-block text-center my-4 mt-lg-6 mb-lg-5 mt-xl-0 mb-xl-0 mt-wd-6 mb-wd-5"><img class="img-fluid" src="{{ asset('frontend/img/564X520/img2.jpg') }}" alt="Image Description"></a>
                                                            <!-- Gallery -->
                                                            <div class="row mx-gutters-2 mb-3">
                                                                <div class="col-auto">
                                                                    <!-- Gallery -->
                                                                    <a class="js-fancybox max-width-60 u-media-viewer" href="javascript:;"
                                                                        data-src="{{ asset('frontend/img/1920X1080/img1.jpg') }}"
                                                                        data-fancybox="fancyboxGallery6"
                                                                        data-caption="Electro in frames - image #01"
                                                                        data-speed="700"
                                                                        data-is-infinite="true">
                                                                        <img class="img-fluid border" src="{{ asset('frontend/img/100X100/img1.jpg') }}" alt="Image Description">
                                                                ...
                                                                <div class="col-auto">
                                                                    <!-- Gallery -->
                                                                    <a class="js-fancybox max-width-60 u-media-viewer" href="javascript:;"
                                                                        data-src="{{ asset('frontend/img/1920X1080/img2.jpg') }}"
                                                                        data-fancybox="fancyboxGallery6"
                                                                        data-caption="Electro in frames - image #02"
                                                                        data-speed="700"
                                                                        data-is-infinite="true">
                                                                        <img class="img-fluid border" src="{{ asset('frontend/img/100X100/img2.jpg') }}" alt="Image Description">
                                                                ...
                                                                <div class="col-auto">
                                                                    <!-- Gallery -->
                                                                    <a class="js-fancybox max-width-60 u-media-viewer" href="javascript:;"
                                                                        data-src="{{ asset('frontend/img/1920X1080/img3.jpg') }}"
                                                                        data-fancybox="fancyboxGallery6"
                                                                        data-caption="Electro in frames - image #03"
                                                                        data-speed="700"
                                                                        data-is-infinite="true">
                                                                        <img class="img-fluid border" src="{{ asset('frontend/img/100X100/img3.jpg') }}" alt="Image Description">
                ...
                <div class="row">
                    <div class="col-wd-3 col-lg-4">
                        <div class="widget-column">
                            ...
                            <ul class="list-unstyled products-group">
                                ...
                                <li class="product-item product-item__list row no-gutters mb-6 remove-divider">
                                    <div class="col-auto">
                                        <a href="../shop/single-product-fullwidth.html" class="d-block width-75 text-center"><img class="img-fluid" src="{{ asset('frontend/img/75X75/img2.jpg') }}" alt="Image Description"></a>
                                    </div>
                                    <div class="col pl-4 d-flex flex-column">
                                ...
                                <li class="product-item product-item__list row no-gutters mb-6 remove-divider">
                                    <div class="col-auto">
                                        <a href="../shop/single-product-fullwidth.html" class="d-block width-75 text-center"><img class="img-fluid" src="{{ asset('frontend/img/75X75/img3.jpg') }}" alt="Image Description"></a>
                                    </div>
                                    <div class="col pl-4 d-flex flex-column">
                    ...
                    <div class="col-wd-3 col-lg-4">
                        ...
                        <ul class="list-unstyled products-group">
                            ...
                            <li class="product-item product-item__list row no-gutters mb-6 remove-divider">
                                <div class="col-auto">
                                    <a href="../shop/single-product-fullwidth.html" class="d-block width-75 text-center"><img class="img-fluid" src="{{ asset('frontend/img/75X75/img5.jpg') }}" alt="Image Description"></a>
                                </div>
                                <div class="col pl-4 d-flex flex-column">
                            ...
                            <li class="product-item product-item__list row no-gutters mb-6 remove-divider">
                                <div class="col-auto">
                                    <a href="../shop/single-product-fullwidth.html" class="d-block width-75 text-center"><img class="img-fluid" src="{{ asset('frontend/img/75X75/img6.jpg') }}" alt="Image Description"></a>
                                </div>
                                <div class="col pl-4 d-flex flex-column">
                    ...
                    <div class="col-wd-3 col-lg-4">
                        ...
                        <ul class="list-unstyled products-group">
                            ...
                            <li class="product-item product-item__list row no-gutters mb-6 remove-divider">
                                <div class="col-auto">
                                    <a href="../shop/single-product-fullwidth.html" class="d-block width-75 text-center"><img class="img-fluid" src="{{ asset('frontend/img/75X75/img8.jpg') }}" alt="Image Description"></a>
                                </div>
                                <div class="col pl-4 d-flex flex-column">
                            ...
                            <li class="product-item product-item__list row no-gutters mb-6 remove-divider">
                                <div class="col-auto">
                                    <a href="../shop/single-product-fullwidth.html" class="d-block width-75 text-center"><img class="img-fluid" src="{{ asset('frontend/img/75X75/img9.jpg') }}" alt="Image Description"></a>
                                </div>
                                <div class="col pl-4 d-flex flex-column">
                    ...
                    <div class="col-wd-3 d-none d-wd-block">
                        <a href="../shop/shop.html" class="d-block"><img class="img-fluid" src="{{ asset('frontend/img/330X360/img1.jpg') }}" alt="Image Description"></a>
                    </div>
                </div>
            </div>
