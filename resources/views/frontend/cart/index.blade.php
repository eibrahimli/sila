...
@section('title', ' Səbətdəki Məhsullar')
...
@section('content')
      ...
      <div class="my-md-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb mb-3 flex-nowrap flex-xl-wrap overflow-auto overflow-xl-visble">
            ...
            <li class="breadcrumb-item flex-shrink-0 flex-xl-shrink-1 active" aria-current="page">Səbətdəki Məhsullar</li>
          </ol>
        </nav>
      </div>
      <!-- End breadcrumb -->
  ...
  <div class="container">
    <cart-index checkout_url="{{ route('cart.checkout') }}" get_cart="{{ route('cart.getCart') }}"></cart-index>
    <!-- Brand Carousel -->
