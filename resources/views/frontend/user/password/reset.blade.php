...
@section('title', 'Sila Express | Şifrəni unutmusan?')
    ...
    <div class="my-md-3">
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb mb-3 flex-nowrap flex-xl-wrap overflow-auto overflow-xl-visble">
          ...
          <li class="breadcrumb-item flex-shrink-0 flex-xl-shrink-1"><a href="{{ route('user.loginregister') }}">Mənim Hesabım</a></li>
          <li class="breadcrumb-item flex-shrink-0 flex-xl-shrink-1" aria-current="page">Şifrəni Unutdum</li>
        </ol>
      </nav>
    </div>
    <!-- End breadcrumb -->
...
<div class="container">
  ...
  <div class="my-4 my-xl-8">
    <div class="row">
      <!-- Password reset vue component -->
        <reset token="{{ $token }}" inputemail="{{ $email }}" url="{{ route('user.loginregister') }}"></reset>
      <!-- End Password reset vue component -->
    </div>
  </div>
</div>
