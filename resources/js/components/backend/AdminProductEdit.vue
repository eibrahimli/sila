<template>
  <div>
    ...
    <div v-show="!loading">
      ...
      <div class="card m-b-30" v-if="hasColor">
        <div class="card-header">
          <h5 class="m-b-0">
...
export default {
  ...
  mounted() {
    ...
    axios
      ...
      .then(res => {
        ...
        this.specs = Object.values(res.data.specs)
        this.brands = Object.values(res.data.brands)
        this.colors = Object.values(res.data.colors)
        this.photos = Object.values(res.data.photos)
        this.productColors = Object.values(res.data.productColors)
  ...
  methods: {
    ...
    submit: function () {
      ...
      if (this.$v.$invalid) {
        ...
        setTimeout(() => {
          ...
          axios
            .post(this.updateproducturl, formdata)
    ...
    deletePhotos: function (event) {
      ...
      axios
        ...
        .then(res => {
          ...
          axios.get(vm.getproducturl).then(res => (vm.photos = res.data.photos));
    ...
    updateColorStock: function (id, color, photo, quantity, index) {
      ...
      axios
        .post(this.update_product_color, formData)
        .then(res => {
          axios.get(this.getproducturl).then(res => {
            vm.productColors = res.data.productColors;
            vm.productColors[colors_index].photo =
              res.data.productColors[colors_index].photo;
