    ...
    >
      ...
      <div class="form-row">
        <div class="col-md-6 form-group">
          ...
          <v-select :options="['Az','En','Ru','Tr']" placeholder="Dil seçin" id="lang" v-model.trim="$v.category.lang.$model" :class="{
        ...
        <div class="col-md-6 form-group">
          ...
          <v-select label="name" placeholder="Kateqoriya seçin" :options="options" :reduce="category => category.id" v-model.trim="$v.category.category_id.$model">                        
          </v-select>     
