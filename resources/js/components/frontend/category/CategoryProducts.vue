  ...
  <div class="row mb-8">
    ...
    <div class="col-xl-9 col-wd-9gdot5">
          ...
          <form method="get">
            ...
            <select
              ...
              class="
                ...
                selectpicker
                dropdown-select
                max-width-200 max-width-160-sm
                right-dropdown-0
                px-2 px-xl-0
              "
        ...
        >
          <ul class="row list-unstyled products-group no-gutters">
            ...
            <div v-else class="col-12">
              <div class="row col-12">
                <div v-if="category.banner_photo" class="mb-6 col-12">
                  <a :href="category.url" class="d-block text-gray-90" style="width: 100%">
                    <div
                      style="height: 206px; border-radius: 1rem"
                      :style="{
                        backgroundImage:
                          'url(' +
                          base_url +
                          '/storage/' +
                          category.banner_photo +
                          ')',
                      }"
                    ></div>
                  </a>
      ...
      <nav
        ...
        class="d-md-flex justify-content-end align-items-center border-top pt-3"
...
export default {
  ...
  methods: {
    ...
    getResults(page = 1) {
      axios
        .get(Laravel.base_url + "/category/get/" + this.id + "?page=" + page)
        .then((response) => {
    ...
    getColors() {
      axios
        .get(this.get_all_colors)
        .then((res) => (this.colors = res.data.colors));
    },

    getBrands() {
      axios
        .get(this.get_all_brands)
    ...
    loadProducts() {
      this.loader = true;
      axios
        .get(this.sorting_category_product, {
