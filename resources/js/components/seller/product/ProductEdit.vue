          ...
          <div v-if="hasColor" class="table-responsive-sm">
            ...
            <table class="table">
              ...
              <tr v-for="(productColor, index) in productColors" :key="index" class="mt-1">
                <td>
                  <select v-model="productColor.color_id" class=" mt-1" aria-placeholder="Rəng seçin...">
                ...
                <td>
                  <img :src="productColor.path"
                       ...
                       width="60" height="60"
                  >
                  <input type="file" @change="productColor.photo = $event.target.files[0]" class="mt-1">
                </td>
                <td>
                  <input type="number" class="form-control mt-1" v-model.number.trim="productColor.quantity">
                </td>
                <td>
                  <button
                  ...
                  <button class="btn btn-small btn-danger col-12 mb-1">Sil</button>
                </td>
              </tr>
              </tbody>
            </table>
              ...
              <tr class="mt-1">
                <td>
                  <select v-model="color_id" class=" mt-1" aria-placeholder="Rəng seçin...">
                    <option value="0" selected disabled>Rəng seçin...</option>
                    <option v-if="!productColors.find((productColor) => { return productColor.color_id == color.id})" v-for="color in colors" :value="color.id">{{ color.label }}</option>
                  </select>
                </td>
                <td>
