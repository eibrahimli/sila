    ...
    >
      ...
      <div class="form-row">
        <div class="form-group col-md-6">
          ...
          <div v-if="!$v.store.keyw.numeric && $v.store.keyw.$dirty" class="invalid-feedback">
            Nömrə rəqəmlərdən ibarət olmalıdır...
          </div>
        </div>        
        <div class="form-group col-md-6">
    ...
    submit() {
      ...
      if (this.$v.$invalid) {
        ...
        setTimeout(() => {          
          ...
          for (var [key, value] of Object.entries(this.store)) {
