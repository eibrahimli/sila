...
class AdminCategoryController extends Controller
{
  ...
  public function store(Request $request) {
    ...
    try {      
      ...
      return response()->json(['error' => 'Kateqoriya əlavə edilərkən xəta baş verdi'],422);
    } 
  }
  ...
  public function update(Request $request , Category $category) {
    ...
    try {      
      ...
      return response()->json(['mes' => 'Kateqoriya uğurla yeniləndi...']);
    }catch(Exception $e) {
      return response()->json(['error' => 'Kateqoriya yenilənərkən xəta baş verdi'],422);
    } 
  }
